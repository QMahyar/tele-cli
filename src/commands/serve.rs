...
mod tests {
    ...
    fn lane_and_timeout_table_is_locked() {
        let expected: &[(&str, Lane, Option<u64>)] = &[
            ...
            ("msg poll-close", Lane::Mutate, Some(30)),
            ("msg poll-results", Lane::Read, Some(30)),
            ("msg poll-unread", Lane::Read, Some(30)),
            ("msg poll-votes", Lane::Read, Some(30)),
            ("msg react", Lane::Mutate, Some(30)),
            ("msg read", Lane::Mutate, Some(30)),
            ("msg search", Lane::Read, Some(120)),
            ("msg send", Lane::Mutate, Some(30)),
            ("msg transcribe", Lane::Mutate, Some(30)),
            ("msg transcribe-rate", Lane::Mutate, Some(30)),
            ("msg translate", Lane::Read, Some(30)),
            ...
            ("story edit", Lane::Mutate, Some(600)),
            ("story link", Lane::Read, Some(30)),
            ("story list", Lane::Read, Some(120)),
            ("story pin", Lane::Mutate, Some(30)),
            ("story reactions", Lane::Read, Some(120)),
            ("story read", Lane::Mutate, Some(30)),
            ("story send", Lane::Mutate, Some(600)),
            ("story unpin", Lane::Mutate, Some(30)),
            ("story viewers", Lane::Read, Some(120)),
            ("story views", Lane::Read, Some(30)),
    ...
    fn route_hints_table_is_locked() {
        let expected: &[(&str, bool, bool, bool)] = &[
            ...
            ("msg export", true, false, false),
            ("msg forward", false, false, false),
            ("msg get", true, false, true),
            ("msg pin", false, false, true),
            ("msg poll-close", false, false, true),
            ("msg poll-results", true, false, true),
            ("msg poll-unread", true, false, true),
            ("msg poll-votes", true, false, true),
            ...
            ("msg transcribe", false, false, true),
            ("msg transcribe-rate", false, false, true),
            ("msg translate", true, false, true),
            ...
            ("profile photos", true, false, true),
            ...
            ("story edit", false, false, true),
            ("story link", true, false, true),
            ("story list", true, false, true),
            ("story pin", false, false, true),
            ("story reactions", true, false, true),
            ("story read", false, false, true),
            ("story send", false, false, true),
            ("story unpin", false, false, true),
            ("story viewers", true, false, true),
            ("story views", true, false, true),
            ...
            ("chat permissions", true, false, true),

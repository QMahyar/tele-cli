...
- [ ] Live verify: MCP Inspector (npx @modelcontextprotocol/inspector) tools/list + dry-run call + one real send; claude mcp add smoke — NEXT UP: live Inspector verification is the only remaining MCP item
